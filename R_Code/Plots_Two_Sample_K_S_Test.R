...
for (i in seq (2, 2927, 48)){
  ...
  ggsave (file = paste0 ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Projects/Merja_Sui_Olink_Project/Olink_Project_Results/Empirical_Cumulative_Distribution_Functions/", k, "_EDF_Plot.pdf"), plot = pl, width = 11.69, height = 8.27, units = "in")
  k = k + 1
}
